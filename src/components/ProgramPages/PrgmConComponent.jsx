...
export default function PrgmConComponent({ propsContent }) {
  ...
  return (
    <div className='lg:my-6 lg:ml-4'>
      ...
      {copyStatus && <div className='absolute top-50 right-5'><img src={copygif} alt="copygif" className='w-24 h-24' /><p style={{ color: "green" }} id="copybtn" className='my-1'>{copyStatus}</p></div>}
